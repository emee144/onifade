...
},
{
...
},
  {
    ...
    description: 'Full-stack event management system with ticketing, calendar sync, and admin controls.',
    tech: ['ASP.NET Core', 'C#', 'SQL Server', 'React', 'Azure'],
    link: 'https://event-booking-demo.azurewebsites.net',
    repo: 'https://github.com/emee144/event-platform',
    type: 'Web App',
  },
  {
    title: 'Habit Tracker App',
    description: 'Mobile habit-building app with streaks, reminders, analytics, and motivational quotes.',
    tech: ['React Native', 'Expo', 'SQLite', 'Push Notifications'],
    link: 'https://habit-tracker-demo.netlify.app',
    repo: 'https://github.com/emee144/habit-tracker',
    type: 'Mobile App',
  },
  {
